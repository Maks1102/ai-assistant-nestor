...
MESSAGE_CLASSES: dict[str, dict] = {
    ...
    "concept_student_message_about_searching_lesson_notes": {
        "keywords": [
        ...
        "examples": [
            "Пришли конспект по теме нейронные сети",
            "Скинь конспекты по теме математический аппарат",
            "Нужен конспект по теории",
            "Пришли конспект урока",
            "Конспекты по теме градиентный спуск",
            "Скинь конспекты лекций",
            "Нужны конспекты по предмету",
            "Пришли конспект по теме функция потерь",
            "Дай конспекты по курсу ИИ",
            "Покажи конспекты по теме нейросети",
            "Где конспекты по теме?",
            "Хочу конспект по обратному распространению",
        ],
    },
    "concept_student_message_about_searching_homework_tasks": {
        "keywords": [
        ...
        "examples": [
            "Пришли задачи по теме нейронные сети",
            "Скинь задания по теме математический аппарат",
            "Нужны задачи по теории",
            "Пришли задание",
            "Задачи по теме градиентный спуск",
            "Скинь практические задания",
            "Домашнее задание по теме",
            "Где задачи по теме?",
            "Покажи задания по курсу ИИ",
            "Хочу задачи по теме нейросети",
            "Пришли упражнения по теме",
            "Выдай задачи по обратному распространению",
        ],
    },
